...
public partial class Modules_Account_Statement_account_statement : System.Web.UI.Page
{
    ...
    public void GetHtmlContent()
    {
        ...
        PdfWriter.GetInstance(pdfDoc, new FileStream(HttpContext.Current.Server.MapPath("..\\Supplier\\AccountStatements\\" + FileNameField.Value.ToString() + ".pdf"), FileMode.Create, System.IO.FileAccess.Write));
