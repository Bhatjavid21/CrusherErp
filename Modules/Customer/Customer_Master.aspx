<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer_Master.aspx.cs" Inherits="Modules_MRM_mrm_list" %>
...
<body class="hold-transition skin-info-light fixed sidebar-mini">
    <form id="frm" runat="server">
        ...
        <div class="modal fade" id="Popup" tabindex="">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="PopUpTitle">Add Customer</h5>
                        <button type="button" class="close" data-dismiss="modal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" id="AllContent">
                        <div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success right" id="btnSave" onclick="Save_Customer()">Save</button>
                    </div>
                </div>
            </div>
        </div>
