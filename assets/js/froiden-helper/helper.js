(function($) {
    ...
    $.easyAjax = function(options) {
        ...
        function modnotify(msg, from, align, icon, type, animIn, animOut, status){
            $.growl({
                icon: icon,
                title: ' ',
                message: msg,
        ...
        function showResponseMessage(msg, type, toastrOptions) {
            ...
            if (opt.messagePosition == "toastr") {
                ...
                */
                ...
                var nFrom = "top";
                var nAlign = "right";
                var nIcons = "fa fa-bell-o";
                var nType = typeClasses[type];
                var nAnimIn = "animated fadeIn";
                var nAnimOut = "animated fadeOut";
                modnotify(msg, nFrom, nAlign, nIcons, nType, nAnimIn, nAnimOut, type);
    ...
    $.ajaxModal = function(selector, url, onLoad) {
        ...
        $(''+selector+' .modal-body').load(url,function(){ 
